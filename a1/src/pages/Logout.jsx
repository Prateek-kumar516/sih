...
export default function Login() {
  ...
  return (
    <div className="bg-gray-300 font-['Manrope',_sans-serif] min-h-screen flex flex-col">
      {/* Background */}
            ...
            <div className="bg-white/90 backdrop-blur-xl rounded-xl p-10 min-h-[600px] flex flex-col justify-center">
              ...
              <form className="space-y-6" onSubmit={handleSubmit}>
                ...
                <div className="pt-4">
                  <button
                    type="submit"
                    className="w-full flex justify-center py-4 px-4 border border-transparent rounded-lg shadow-sm text-base font-bold text-white bg-blue-400 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-all duration-300"
                  >
                    Sign In
                  </button>
                </div>
